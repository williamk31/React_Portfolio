export default function Resume() {
    return (
        <div className="container">
            ...
            <p>Manage the successful integration of various third-party web applications with the resort's POS system, including implementing custom features to drive sales.
            Work closely with the managers of all revenue-based departments to ensure the smooth operation of each department's function within the resort operations.
            Manage the intersection of the software systems and the users to enhance the guest experience.
            </p>
